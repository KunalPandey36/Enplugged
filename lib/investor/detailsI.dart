...
class DetailsI extends StatefulWidget {
  DetailsI({Key key}) : super(key: key);

  @override
  _DetailsIState createState() => _DetailsIState();
}

class _DetailsIState extends State<DetailsI> {
    ...
    return Scaffold(
        body: StreamBuilder(
            ...
            builder: (context, profile) {
              ...
              totalturnover = profile.data["totalturnover"];
              successpercent = profile.data["successpercentage"];
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "$name  is a business Organisation with valuation of :Rs.$totalturnover /- \n \n Success percentage of :$successpercent \n \n Total of $companysuccess Successfull Companies Since $since Years",
                              style: TextStyle(
                                fontSize: 22.0,
