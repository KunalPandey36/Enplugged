    ...
    return Scaffold(
        body: StreamBuilder(
            ...
            builder: (context, profile) {
              ...
              totalturnover = profile.data["fundingamount"].toString();
              successpercent = profile.data["successpercentage"].toString();
              since = profile.data["experienceinyear"].toString();
              companysuccess = profile.data["totalnoofemployee"].toString();
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "$name  is a Entrepreneur with Funding of Over :$since Years /- \n \n Success percentage of :$successpercent \n \n Total Employee Count of $companysuccess Successfull Companies",
                              style: TextStyle(
                                fontSize: 22.0,
