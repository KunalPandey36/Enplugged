...
import 'package:enplugged/entrepreneur/connectionsE.dart';
...
class DashboardE extends StatefulWidget {
  DashboardE({Key key}) : super(key: key);

  @override
  _DashboardEState createState() => _DashboardEState();
}
  ...
  static List<Widget> _widgetOptions = <Widget>[
    ...
    StreamBuilder(
        ...
        builder: (context, profile) {
          ...
          namepost = name;
          turnover = profile.data["fundingamount"].toString();
